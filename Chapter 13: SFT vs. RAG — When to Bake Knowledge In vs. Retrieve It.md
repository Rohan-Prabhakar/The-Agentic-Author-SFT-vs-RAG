...
The accompanying notebook demonstrates this boundary directly. A mock SFT backbone frozen at November 2023 returns $15,000 for the volatile query. The hybrid system routes the same query to RAG and returns $25,000. The router correctly classifies a stable query, the legal definition of an investment adviser, as LOW_V with 0.95 confidence and routes it to parametric memory at zero retrieval cost. The contrast between the two outputs is the architectural argument made executable.
